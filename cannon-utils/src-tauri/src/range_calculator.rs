...
#[tauri::command]
pub fn get_range_custom(barrel: String, power_amount: f64, tick_amount: i32, power: Vector3f64, projectile: Vector3f64) -> RangeInfo {
...
pub fn get_range_stair(power_amount: f64, tick_amount: i32) -> RangeInfo {
    get_range_custom(String::from("Stair"), power_amount, tick_amount, Vector3f64::new(0.0, 0.0, 0.0), Vector3f64::new(0.5199999809266, 0.5199999809265, 0.98000001907))
}

#[tauri::command]
pub fn get_range_trapdoor(power_amount: f64, tick_amount: i32) -> RangeInfo {
    get_range_custom(String::from("Trapdoor"), power_amount, tick_amount, Vector3f64::new(0.0, 0.0, 0.0), Vector3f64::new(0.8324999809266, 0.5199999809265, 0.98000001908))
}

#[tauri::command]
pub fn get_range_cobblestone_wall(power_amount: f64, tick_amount: i32) -> RangeInfo {
    get_range_custom(String::from("Cobblestone Wall"), power_amount, tick_amount, Vector3f64::new(0.0, 0.0, 0.0), Vector3f64::new(0.2699999809266, 0.5199999809265, 0.98000001908))
}

#[tauri::command]
pub fn get_range_ladder(power_amount: f64, tick_amount: i32) -> RangeInfo {
    get_range_custom(String::from("Ladder"), power_amount, tick_amount, Vector3f64::new(0.0, 0.0, 0.0), Vector3f64::new(0.8949999809266, 0.5199999809265, 0.98000001908))
}

#[tauri::command]
pub fn get_range_chest(power_amount: f64, tick_amount: i32) -> RangeInfo {
    get_range_custom(String::from("Chest"), power_amount, tick_amount, Vector3f64::new(0.0, 0.0, 0.0), Vector3f64::new(0.0824999809266, 0.5199999809265, 0.98000001908))
}